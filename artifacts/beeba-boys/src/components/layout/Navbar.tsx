    ...
    >
      <div className="container mx-auto px-4 md:px-8 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <Link href="/book" className="ghost-btn-gold px-6 py-2 ml-4">
            Book Now
          </Link>
        </nav>
        ...
        {/* Mobile Nav */}
        <div className={`fixed inset-0 bg-background flex flex-col items-center justify-center gap-8 transition-transform duration-500 ease-in-out z-40 md:hidden ${
          ...
          <Link 
            href="/book" 
            onClick={() => setMobileMenuOpen(false)}
            className="ghost-btn-gold px-8 py-3 text-lg mt-4"
          >
            Book Now
          </Link>
        </div>
